...
class GraphicsPipelineFactory {
    ...
    public:
       ...
       * @param shader_path the path to the SLANG shader file to use
       *
       * @return the graphics pipeline
       */
      std::unique_ptr<vk::raii::Pipeline> createGraphicsPipeline(std::shared_ptr<LogicalDevice> logical_device,
    ...
    private:
       ...
       */
      std::unique_ptr<vk::raii::ShaderModule> createShaderModule(std::shared_ptr<LogicalDevice> logical_device,
                                                                 const std::vector<char>&       byte_code) const;
};